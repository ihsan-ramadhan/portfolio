...
export function EducationTab({ token, setMessage }: Readonly<EducationTabProps>) {
  ...
  if (isLoading) {
    return <div className="font-mono text-text-muted animate-pulse">Loading education...</div>;
  }
            ...
            {educations.map((edu) => (
              ...
              >
                <div className="space-y-2">
                  ...
                  <p className="text-xs font-mono text-primary">{edu.major}</p>
          ...
          >
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              <div className="space-y-1">
                <label className="text-xs font-mono text-text-muted uppercase">Institution</label>
                <input 
                  type="text" 
                  required
              ...
              <div className="space-y-1">
                <label className="text-xs font-mono text-text-muted uppercase">Major / Field of Study</label>
                <input 
                  type="text" 
                  required
                  value={form.major}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-xs font-mono text-text-muted uppercase">Start Year</label>
                  <input 
                    type="number" 
                    required
                ...
                <div className="space-y-1">
                  <label className="text-xs font-mono text-text-muted uppercase">End Year (or Expected)</label>
                  <input 
                    type="number" 
                    required
                    value={form.endYear}
