          ...
          <div className="p-8 rounded-2xl glass-panel hover-glow relative overflow-hidden">
            ...
            {submitted ? (
              ...
              <form className="space-y-4 relative z-10" onSubmit={handleSubmit} noValidate>
                <div>
                  <label htmlFor="name" className="block text-xs font-mono text-text-muted mb-2 uppercase tracking-widest">Name</label>
                  <input 
                    id="name"
                    name="name"
                    type="text" 
                ...
                <div>
                  <label htmlFor="email" className="block text-xs font-mono text-text-muted mb-2 uppercase tracking-widest">Email</label>
                  <input 
                    id="email"
                    name="email"
                    type="email" 
                ...
                <div>
                  <label htmlFor="message" className="block text-xs font-mono text-text-muted mb-2 uppercase tracking-widest">Message</label>
                  <textarea 
                    id="message"
                    name="message"
                    rows={4}
